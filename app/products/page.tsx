    ...
    const matchesTags =
      ...
      (product.tags &&
        (product.tags.some((tag) => selectedTags.includes(tag)) ||
          (selectedTags.includes("FEU Products") &&
            product.tags.includes("FEU Products"))));
  ...
  return (
    <div className="flex flex-col md:flex-row gap-6 p-4">
                    ...
                    <div className="space-y-2 pl-2">
                      {tags.map((tag) => (
                        <div key={tag} className="flex items-center space-x-2">
                          ...
                          <Label
                            htmlFor={
                              tag === "FEU Products" ? "feu-products" : tag
                            }
                            className={
                              tag === "FEU Products"
      ...
      <div className="w-full md:w-3/4">
        ...
        (selectedTags.length > 0 || selectedPriceRange || searchQuery) ? (
          <div className="text-center py-8">
            <p className="text-gray-500">
              No products match your selected filters or search query.
            </p>
